...
DocumentSnapshot data = await studentsCollection.get()
...
FirebaseFirestore.instance.collection('students').
doc('Enil4cLaiFINDVNCRFGJ').delete();

studentsCollection.doc('Enil4cLaiFINDVNCRFGJ').delete();



studentsCollection.doc('Enil4cLaiFINDVNCRFGJ').update(Data);
